...
def get_parser():
    ...
    parser.add_argument('--optim', default='fastadabelief', type=str, help='optimizer',
                        choices=['sgd', 'adam', 'fastadabelief'
                                 ])
...
def get_ckpt_name(model='resnet', optimizer='fastadabelief', lr=0.1, final_lr=0.1, momentum=0.9,
    ...
    name = {
        ...
        'fastadabelief': 'lr{}-betas{}-{}-eps{}-wdecay{}-run{}'.format(lr, beta1, beta2, eps, weight_decay, run),
    }[optimizer]
...
def create_optimizer(args, model_params):
    ...
    elif args.optim == 'fastadabelief':
        return FastAdaBelief(model_params, args.lr, betas=(args.beta1, args.beta2),
                          weight_decay=args.weight_decay, eps=args.eps)

...
class FastAdaBelief(Optimizer):
    """Implements FastAdaBelief algorithm. Modified from AdaBelief in PyTorch
    """
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.9), eps=1e-8,
        ...
        if amsgrad:
            print('AMS enabled in FastAdaBelief')
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                grad = p.grad.data
                if grad.is_sparse:
                    raise RuntimeError('FastAdaBelief does not support sparse gradients, please consider SparseAdam instead')
                amsgrad = group['amsgrad']
                ...
                if amsgrad:
                    ...
                    max_exp_avg_var = max_exp_avg_var.add_(group[0.5/state['step']])
